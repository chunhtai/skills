...
1. If no reproduceible example, come up with one by parsing the error message, stacktrace and use flutter codebase to come up with reproducible test case. The result should be a code block with <details> tag.
